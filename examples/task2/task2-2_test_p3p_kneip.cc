 ...
 * @param poses
 */
void compute_p3p(sfm::Correspondences2D3D const &corresp, math::Matrix<double, 3, 3> const &inv_k_matrix, PutativePoses *poses)
{
...
int main(int argc, char *argv[])
{
    ...
    // 计算相机坐标系中对应的摄线
    math::Vec3d f1 = inv_k_matrix.mult(math::Vec3d(uv1[0], uv1[1], 1.0)); // 归一化到摄像机坐标系
